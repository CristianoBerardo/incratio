...
1. Non mollare - per che scopo lo fai?
   - Creazione di qualcosa di MIO
   - Esperienza da inserire sul CV - orgogio personale
   - Possibile progetto di tesi se e solo se riuscirai ad attaccare un database e magari anche redis
   - Creazione di un tool online per l'analisi di portafogli finanziari di investitori retail
...
- [ ] Riorganizzazione del progetto
  ...
  - [ ] Imparare ad usare Nodemon per automatizzare il processo di sviluppo
- [ ] Utilizzare solo file .json, .ts e .js.
